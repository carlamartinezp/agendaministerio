...
jQuery(document).ready(function($) {
	...
	var container2 = $('.portfolio-wrapper-inner');
	...
	var container3 = $('.portfolio-wrapper-temas');
	...
	var firma = "<br /><br /><strong style=\"color:white;\">JosÃ© Antonio GÃ³mez, Ministro de Defensa Nacional.</strong>";
	var quotes = new Array("Los Estados para ser libres y autÃ³nomos requieren, como necesidad bÃ¡sica, resguardar su independencia y soberanÃ­a  territorial.", "La incorporaciÃ³n de las mujeres a las Fuerzas Armadas ha ido creciendo y hoy, hay  muy pocos niveles dentro de las instituciones, donde las mujeres no pueden participar.", "La ConstituciÃ³n PolÃ­tica del Estado establece que las  Fuerzas Armadas son organismos dependientes y obedientes del poder polÃ­tico y se vinculan con el Gobierno a travÃ©s del Ministerio de Defensa Nacional.", "Los organismos de la Defensa Nacional son instituciones de La RepÃºblica, que nos pertenecen a todos, a cada uno de los chilenos. No son un compartimiento estanco de la institucionalidad democrÃ¡tica y existen para la protecciÃ³n de la Patria.","La modernizaciÃ³n de la Defensa Nacional nos obliga construir una visiÃ³n integral, no solo en tÃ©rminos de soberanÃ­a, sino frente a amenazas surgidas del cambio climÃ¡tico y calentamiento global y fenÃ³menos naturales recurrentes.","Las Fuerzas Armadas cumplen su trabajo a partir de un lineamiento PolÃ­tico EstratÃ©gico definido por la Presidenta de La RepÃºblica, a travÃ©s del Ministerio de Defensa, siendo su misiÃ³n tradicional y esencial garantizar nuestra soberanÃ­a y mantener la integridad del territorial.","Las Fuerzas Armadas tiene el desafÃ­o de modernizar sus capacidades disuasivas, de respuesta y renovaciÃ³n, manteniendo y fortaleciendo su potencial bÃ©lico como la capacidad profesional y tÃ©cnica de su personal. ","La Presidenta Michelle Bachelet ha resuelto potenciar las capacidades polivalentes de nuestras Fuerzas Armadas para permitir su inclusiÃ³n plena en la sociedad civil, aportando al desarrollo cientÃ­fico, tecnolÃ³gico, econÃ³mico, cultural y social del paÃ­s."),
    randno = quotes[Math.floor( Math.random() * quotes.length )];
    $('#quotes_footer').html( randno + firma);
